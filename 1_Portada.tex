...
% 		\textcolor{blue}{\hrule\hrule}
 		\vspace{5mm}
		\begin{flushleft}
			\huge{Desarrollo de un sistema embebido de adquisición de datos y telemetría satelital para la boya instrumental para monitoreo acústico}
		\end{flushleft}
		\vspace{8mm}
		\begin{flushright}
			\Large{Patricio Bos}\\
...
% 		\textcolor{blue}{\hrule\hrule}
	...
	\begin{minipage}[c][30mm][c]{1.0\linewidth} 		
		\begin{flushright}
			\Large{Departamento Investigación\\
